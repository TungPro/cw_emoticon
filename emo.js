$(window).ready(function(){
        ...
        CW.reg_cmp.push({key:/\(cuoideu4\)/g, rep: "<img src='http://aoevietnam.org/images/icon2009/cuoideu.gif' alt='(cuoideu)' title='(cuoideu)' class='ui_emoticon'/>", reptxt:'(cuoideu2)'});
});
